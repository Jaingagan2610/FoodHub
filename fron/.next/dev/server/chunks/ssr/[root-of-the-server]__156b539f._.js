...
;
function LoginPage() {
    const loginStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$useAuth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const handleLogin = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/auth/login", form);
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$useAuth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"].getState().setUser(res.data.user);
            const role = res.data.user.role;
            if (role === "admin") router.push("/dashboard/admin/main");
            else if (role === "manager") router.push("/dashboard/manager");
            else router.push("/");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__156b539f._.js.map
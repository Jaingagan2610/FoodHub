...
"[project]/src/store/useAuth.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const useAuth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["create"])((set)=>({
        ...
        loadUser: async ()=>{
            ...
            try {
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("/users/profile");
                set({
                    user: res.data,
                    loading: false
                });
...
const useCart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["create"])()((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$middleware$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["persist"])((set, get)=>({
        ...
        // Increase quantity
        increaseQty: (id)=>set({
                cartItems: get().cartItems.map((i)=>i.id === id ? {
                        ...i,
                        quantity: i.quantity + 1
                    } : i)
            }),
        // Decrease quantity
        decreaseQty: (id)=>set({
                cartItems: get().cartItems.map((i)=>i.id === id && i.quantity > 1 ? {
                        ...i,
                        quantity: i.quantity - 1
...
;
function Header() {
    const { user, loading, restoreUser, logout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$useAuth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    const { cartItems } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$useCart$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCart"])();
    ...
    const dashboardPath = user?.role === "admin" ? "/dashboard/admin/main" : user?.role === "manager" ? "/dashboard/manager" : "/dashboard/member";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__be79a87f._.js.map
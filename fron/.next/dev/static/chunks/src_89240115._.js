...
function CartPage() {
    _s();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])(); // NOW it works
    ...
    const updateQuantity = async (id, qty)=>{
        if (qty < 1) return;
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`/cart/${id}`, {
                quantity: qty
            });
    ...
    const removeItem = async (id)=>{
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/cart/${id}`);
...
_s(CartPage, "yLtsLS4h6QH4qoJMGEmB6JE1zyU=", false, function() {
    return [
...
//# sourceMappingURL=src_89240115._.js.map
...
function Header() {
    _s();
    const { user, setUser, logout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
            ...
            const loadUser = {
                "Header.useEffect.loadUser": async ()=>{
                    if (!user && localStorage.getItem("token")) {
                        try {
                            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/users/profile");
                            setUser(res.data);
                        } catch  {
                            logout();
                        }
...
_s(Header, "YLVUqYFWCcKVZd1h4BCZ5KL9/hs=", false, function() {
    return [
...
//# sourceMappingURL=src_f6d9bed2._.js.map
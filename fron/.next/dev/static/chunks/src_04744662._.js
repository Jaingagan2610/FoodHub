...
function MyOrdersPage() {
    ...
    const fetchOrders = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/orders/my");
            setOrders(res.data);
        } catch (err) {

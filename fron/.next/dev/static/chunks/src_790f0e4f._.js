...
function CheckoutPage() {
    ...
    const fetchCart = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/cart");
    ...
    const handlePayment = async ()=>{
        try {
            ...
            const orderRes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/orders", orderBody);
            const createdOrder = orderRes.data;
            const orderId = createdOrder.id;
            console.log("Order Created:", orderId);
            // 2️⃣ CREATE Razorpay Order
            const rpOrderRes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/payments/create-order", {
                amount
            });
            ...
            const options = {
                ...
                handler: async function(response) {
                    ...
                    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/payments", {
                        orderId: orderId,
                        paymentMethod: "upi"
                    });
                    // 5️⃣ UPDATE ORDER STATUS -> confirmed
                    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`/orders/${orderId}/status`, {
                        status: "confirmed"
                    });
                    // 6️⃣ CLEAR CART
                    for (const item of cartItems){
                        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/cart/${item.id}`);
                    }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            isCartEmpty && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(CheckoutPage, "5mhTbgPUIzhtWihLrkRuVDDgwRY=");
_c = CheckoutPage;
var _c;
...
//# sourceMappingURL=src_790f0e4f._.js.map
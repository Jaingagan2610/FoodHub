...
__decorate([
    (0, typeorm_1.OneToMany)(() => restaurant_entity_1.Restaurant, (restaurant) => restaurant.manager),
    __metadata("design:type", Array)
], User.prototype, "restaurants", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => cart_entity_1.CartItem, (cartItems) => cartItems.user),
    __metadata("design:type", Array)
